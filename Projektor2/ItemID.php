    ...
    public function generuj_cislo(){
        ...
        if($this->p_cislo_projektu &&  $this->b_cislo_rozsahu && $this->c_cislo_kontextu && $this->u_cislo_polozky) {     /*ss*/
           ...
           // echo "<br>cpolozka " . $this->u_cislo_polozky;
            ...
            // počíbaje 19.6.2019 se používí nový identifikátor: npvé předřísůí: 4 a o pozici delší identifikátor - od předčíslí 4 má číslo rozsahu=id kanveláře 3 pozice (máme více než 100 kanceláří)

            $this->i_cislo_identifikacni = "4" .
                                        $this->strnn($this->b_cislo_rozsahu,3) .
