...
class Projektor2_View_HTML_Ap_Zamestnani extends Projektor2_View_HTML_FormularPHP4 {
    ...
    //form
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=ap_zamestnani_uc&save=1" name="zamestnani->form_zamestnani">';
...
<p>
  ...
  <input ID="zam_supm_ano" type="radio" name="zamestnani->zam_supm" value="Ano" <?php if (@$pole['zamestnani->zam_supm'] == 'Ano') {echo 'checked';} ?>>
  Ano &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input ID="zam_supm_ne" type="radio" value="Ne" name="zamestnani->zam_supm" <?php if (@$pole['zamestnani->zam_supm'] == 'Ne') {echo 'checked';} ?>>
  Ne<br>
</p>
