 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Ap_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=ap_souhlas_uc" name="smlouva->form_souhlas">';
