 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Zpm_Smlouva extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=zpm_sml_uc" name="smlouva->form_sml">';
