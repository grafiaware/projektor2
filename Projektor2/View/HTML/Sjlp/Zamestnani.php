 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjlp_Zamestnani extends Projektor2_View_HTML_FormularPHP4 {
    ...
    //form
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=sjlp_zamestnani_uc&save=1" name="zamestnani->form_zamestnani">';
...
<p>
  ...
  <input ID="zam_datum_vstupu" type="date" name="zamestnani->zam_datum_vstupu" size="10" maxlength="10" value="<?php echo @$pole['zamestnani->zam_datum_vstupu'];?>" required>
</p>
  
<FIELDSET><LEGEND><b>Údaje o zaměstnavateli</b></LEGEND>
  <p>
  Název zaměstnavatele:
  <input ID="zam_nazev" type="text" name="zamestnani->zam_nazev" size="120" maxlength="255" value="<?php echo @$pole['zamestnani->zam_nazev'];?>" required>
  <br>IČ:
  <input ID="zam_ic" type="text" name="zamestnani->zam_ic" size="20" maxlength="20" value="<?php echo @$pole['zamestnani->zam_ic'];?>" required> 
 </p> 
