 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjlp_Export extends Framework_View_Abstract {
        ...
        $this->parts[] = '<div class="content">';
            $this->parts[] = '
                            <form method="POST" action="index.php?akce=export" name="vyber_tabulky">
                                ...
                                <option >------------</option>
                                <option value=v_Sjlp_zajemci>Monitoring - všichni zájemci v projektu</option>
                                <option value=v_Sjlp_kurzy>Monitoring - všechny kurzy v projektu</option>
