 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjlp_IPPoradenstvi extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    public function display() {
        ...
        echo '<H3>INDIVIDUÁLNÍ PLÁN ÚČASTNÍKA PROJEKTU S jazyky pro lepší práci</H3>';
        echo '<H4>Plán poradenských aktivit</H4>';
        echo '<form method="POST" action="index.php?osoby=form&form=sjlp_porad_uc" name="form_porad">';

        $aktivity = Config_Aktivity::getAktivityProjektu('SJLP');
