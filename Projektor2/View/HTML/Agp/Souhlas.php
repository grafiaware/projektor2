 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Agp_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<H3>SOUHLAS SE ZPRACOVÁNÍM OSOBNICH UDAJŮ</H3>';

    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=agp_souhlas_uc" name="smlouva->form_souhlas">';
...
<p>Datum vytvoření:
<input ID="datum_vytvor_smlouvy" type="date" name="smlouva->datum_vytvor_smlouvy" size="8" maxlength="10"  readonly value="<?php
