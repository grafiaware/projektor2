 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Agp_Smlouva extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<form method="POST" action="index.php?akce=form&form=agp_sml_uc" name="smlouva->form">';
