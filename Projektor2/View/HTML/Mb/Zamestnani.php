 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Mb_Zamestnani extends Projektor2_View_HTML_FormularPHP4 {
    ...
    //form
    echo '<form method="POST" action="index.php?akce=form&form=mb_zamestnani_uc&save=1" name="zamestnani->form_zamestnani">';
