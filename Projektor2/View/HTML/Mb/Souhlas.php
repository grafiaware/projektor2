...
class Projektor2_View_HTML_Mb_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<H3>SOUHLAS SE ZPRACOVÁNÍM OSOBNICH UDAJŮ V PROJEKTU Moje budoucnost</H3>';

    echo '<form method="POST" action="index.php?akce=form&form=mb_souhlas_uc" name="smlouva->form_souhlas">';
