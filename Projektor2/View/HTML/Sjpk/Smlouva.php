 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjpk_Smlouva extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<form method="POST" action="index.php?osoby=form&form=sjpk_sml_uc" name="smlouva->form_sml">';
