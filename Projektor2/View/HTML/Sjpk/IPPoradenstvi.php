 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjpk_IPPoradenstvi extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    public function display() {
        ...
        echo '<H3>INDIVIDUÁLNÍ PLÁN ÚČASTNÍKA PROJEKTU S jazyky za prací v Plzeňském a Karlovarském krajii</H3>';
        echo '<H4>Plán poradenských aktivit</H4>';
        echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=sjpk_porad_uc" name="form_porad">';
        
        $aktivity = Projektor2_AppContext::getAktivityProjektu('SJPK');   
