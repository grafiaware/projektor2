 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Help_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<H3>SOUHLAS SE ZPRACOVÁNÍM OSOBNICH UDAJŮ V PROJEKTU</H3>';

    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=he_souhlas_uc" name="smlouva->form_ukonc">';
...
<FIELDSET><LEGEND style="color:white;"><b>Osobní údaje</b></LEGEND>
  ...
  <p>Datum narození: <input ID="datum_narozeni" type="date" name="smlouva->datum_narozeni" size="8" maxlength="10" readonly value="<?php echo @$pole['smlouva->datum_narozeni'];?>">
...
<p>Datum vytvoření:
<input ID="datum_vytvor_smlouvy" type="date" name="smlouva->datum_vytvor_smlouvy" size="8" maxlength="10"  readonly value="<?php echo @$pole['smlouva->datum_vytvor_smlouvy'];?>">
</p>
