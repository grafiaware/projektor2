 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Help_Smlouva extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<form method="POST" action="index.php?osoby=form&form=he_sml_uc" name="smlouva->form_ukonc">';
...
<p>Datum vytvoření:
<input ID="datum_vytvor_smlouvy" type="date" name="smlouva->datum_vytvor_smlouvy" size="8" maxlength="10" value="<?php echo @$pole['smlouva->datum_vytvor_smlouvy'];?>">
</p>
