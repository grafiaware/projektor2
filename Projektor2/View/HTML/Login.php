...
class Projektor2_View_HTML_Login extends Framework_View_Abstract {
    public function render() {
        ...
        $this->parts[] = '<h1>Přihlášení do systému projektor - v2col</h1>';
...
//	    $this->parts[] = '<input type="hidden" name="sent" value="1">';
	    $this->parts[] = '<label for="name" >Uživatelské jméno:</label>';
                    $nameField = Projektor2_Controller_LoginLogout::LOGIN_NAME_FIELD;
		    $this->parts[] = '<input id="name" type ="text" name="'.$nameField.'">';
            $this->parts[] = '<label for="password" >Heslo:</label></td>';
                    $passwordField = Projektor2_Controller_LoginLogout::LOGIN_PASSWORD_FIELD;
		    $this->parts[] = '<input id="password" type="password" name="'.$passwordField.'">';
