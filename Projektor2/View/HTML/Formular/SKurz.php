        ...
        $html[] =
            Html::tag("form", [
                ...
                Html::tag("fieldset", [],
                    ...
                    Html::input($prefix.'kancelar_kod', "Kód kanceláře:", $pole, ["type"=>"text", "size"=>"10", "maxlength"=>"20", "required"=>true]),
                    Html::input($prefix.'kurz_druh', "Druh kurzu:", $pole, ["type"=>"text", "size"=>"8", "maxlength"=>"20", "required"=>true]),

                    Html::input($prefix.'kurz_cislo', "Číslo kurzu:", $pole, ["type"=>"text", "size"=>"8", "maxlength"=>"20", "required"=>true]),
                    Html::input($prefix.'beh_cislo', "Číslo běhu:", $pole, ["type"=>"text", "size"=>"8", "maxlength"=>"20", "required"=>true]),
