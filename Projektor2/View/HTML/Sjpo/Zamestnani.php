 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjpo_Zamestnani extends Projektor2_View_HTML_FormularPHP4 {
    ...
    //form
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=sjpo_zamestnani_uc&save=1" name="zamestnani->form_zamestnani">';
