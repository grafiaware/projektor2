 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjzp_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=sjzp_souhlas_uc" name="smlouva->form_souhlas">';
