 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjzp_IPPoradenstvi extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    public function display() {
        ...
        echo '<form method="POST" action="index.php?osoby=form&form=sjzp_porad_uc" name="form_porad">';
