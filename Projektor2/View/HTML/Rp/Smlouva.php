 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Rp_Smlouva extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=rp_sml_uc" name="smlouva->form_sml">';
