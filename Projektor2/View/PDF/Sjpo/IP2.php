...
* @author pes2704
*/
class Projektor2_View_PDF_Sjpo_IP2 extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $textPaticky = "Individuální plán účastníka v projektu „S jazyky za prací v Plzni a okolí“ - část 2 - vyhodnocení aktivit  ".$this->context["file"];
        ...
        //##################################################################################################
        $aktivity = Projektor2_AppContext::getAktivityProjektu('SJPO');
            $blok = new Projektor2_PDF_Blok;
