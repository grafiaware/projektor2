...
* @author pes2704
*/
class Projektor2_View_PDF_Vzp_IP2 extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $textPaticky = "Individuální plán účastníka programu Vykroč za prací projektu „Vzdělávání a dovednosti pro trh práce II“ - část 2 - vyhodnocení aktivit  ".$this->context["file"];             
        ...
        //##################################################################################################
        $aktivity = Projektor2_AppContext::getAktivityProjektu('VZP'); 
            $blok = new Projektor2_PDF_Blok;
