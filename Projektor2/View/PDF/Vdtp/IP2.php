...
* @author pes2704
*/
class Projektor2_View_PDF_Vdtp_IP2 extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $textPaticky = "Individuální plán účastníka v projektu „Vzdělávání a dovednosti pro trh práce II“ - část 2 - vyhodnocení aktivit  ".$this->context["file"];
