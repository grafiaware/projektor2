...
* @author pes2704
*/
class Projektor2_View_PDF_Vdtp_IP1 extends Projektor2_View_PDF_Common {
    const MODEL_DOTAZNIK = "dotaznik->";
    const MODEL_PLAN = "plan->";

    public function createPDFObject() {
        $textPaticky = "Individuální plán účastníka v projektu „Vzdělávání a dovednosti pro trh práce II“ - část 1 - plán aktivit  ".$this->context["file"];
