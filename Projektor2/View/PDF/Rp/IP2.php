...
* @author pes2704
*/
class Projektor2_View_PDF_Rp_IP2 extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $textPaticky = "Individuální plán účastníka v projektu „Rodina i práce v Plzeňském kraji“ - část 2 - vyhodnocení aktivit  ".$this->context["file"];             
        ...
        //##################################################################################################
        $aktivity = Projektor2_AppContext::getAktivityProjektu('RP'); 
            $blok = new Projektor2_PDF_Blok;
