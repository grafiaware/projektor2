    ...
    public static function prepareHeaderFooter(
        ...
        switch ($sessionStatus->getUserStatus()->getProjekt()->kod) {
            case 'AP':
                ...
                self::completeFooter( $texts['text_paticky']
            ...
            case 'AGP':
                ...
                self::completeFooter( $texts['text_paticky'] , $cislovani);
                break;
            case 'HELP':
            ...
            case 'MB':
                ...
                self::completeFooter( $texts['text_paticky'] . $texts['financovan'], $cislovani);
                break;
            case 'CJC':
