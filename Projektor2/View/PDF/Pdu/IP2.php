...
* @author pes2704
*/
class Projektor2_View_PDF_Pdu_IP2 extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $textPaticky = "Individuální plán účastníka v projektu „Podpora zaměstnanosti dlouhodobě nezaměstnaných uchazečů o zaměstnání“ - část 2 - vyhodnocení aktivit  ".$this->context["file"];
        ...
        //##################################################################################################
        $aktivity = Projektor2_AppContext::getAktivityProjektu('SPP');
            $blok = new Projektor2_PDF_Blok;
