...
* @author pes2704
*/
class Projektor2_View_PDF_Zpm_IP1 extends Projektor2_View_PDF_Common {
    const MODEL_DOTAZNIK = "dotaznik->";
    const MODEL_PLAN = "plan->";

    public function createPDFObject() {
         $textPaticky = "Individuální plán účastníka v projektu „Záruky pro mladé v Plzeňském kraji“ - část 1 - plán aktivit  ".$this->context["file"];       
