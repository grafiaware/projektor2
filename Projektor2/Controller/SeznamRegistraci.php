...
class Projektor2_Controller_SeznamRegistraci extends Projektor2_Controller_Abstract {
    ...
    private function getLeftMenuArrayHelp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=he_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArraySjzp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=sjzp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArrayVzp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=vzp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArrayZpm() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=zpm_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArraySpp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=spp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArrayRp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=rp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArraySjpk() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=sjpk_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArraySjpo() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=sjpo_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArraySjlp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=sjlp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
        if ( ($this->sessionStatus->user->username == "sys_admin" OR $this->sessionStatus->user->username == "so_manager" OR $this->sessionStatus->user->username == "so_monitor")) {
            $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=export', 'text'=>'Exportuj přehled'];
        }
        return $menuArray;
    ...
    protected function getLeftMenuArrayVdtp() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=vdtp_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArrayPdu() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=pdu_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
    ...
    protected function getLeftMenuArrayMb() {
        $menuArray[] = ['href'=>'index.php?akce=osoby&osoby=form&form=mb_novy_zajemce&novy_zajemce', 'text'=>'Nová osoba'];
