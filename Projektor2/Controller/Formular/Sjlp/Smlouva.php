 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjlp_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Sjlp_Smlouva($this->sessionStatus, $this->createContextFromModels()); 
