 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjlp_IP1 extends Projektor2_Controller_Formular_IP {
    ...
    protected function getResultFormular() {
        ...
        $view->assign('nadpis', 'INDIVIDUÁLNÍ PLÁN ÚČASTNÍKA PROJEKTU S jazyky za prací')
            ->assign('formAction', 'sjlp_plan_uc')
     ...
     protected function getResultPdf() {
        if ($this->request->post('pdf') == "Tiskni IP 1.část") {
            ...
            $view = new Projektor2_View_PDF_Sjlp_IP1($this->sessionStatus, $this->createContextFromModels());
