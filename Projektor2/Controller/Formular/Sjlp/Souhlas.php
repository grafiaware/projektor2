...
class Projektor2_Controller_Formular_Sjlp_Souhlas extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultFormular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Sjlp_Souhlas($this->sessionStatus, $this->createContextFromModels(TRUE));    
        $htmlResult .= $view->render();
        return $htmlResult;
    }
    
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Sjlp_Souhlas($this->sessionStatus, $this->createContextFromModels());
