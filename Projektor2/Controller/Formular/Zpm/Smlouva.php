 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Zpm_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function formular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Zpm_Smlouva($this->sessionStatus, $this->createContextFromModels(TRUE));
    ...
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Zpm_Smlouva($this->sessionStatus, $this->createContextFromModels());   //--vs
