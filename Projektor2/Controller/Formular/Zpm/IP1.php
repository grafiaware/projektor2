 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Zpm_IP1 extends Projektor2_Controller_Formular_IP {
    ...
    protected function getResultFormular() {
        ...
        $view->assign('nadpis', 'INDIVIDUÁLNÍ PLÁN účastníka projektu „Záruky pro mladé v Plzeňském kraji“ ')
            ->assign('formAction', 'zpm_plan_uc')
     ...
     protected function getResultPdf() {
        if ($this->request->post('pdf') == "Tiskni IP 1.část") {
            ...
            $view = new Projektor2_View_PDF_Zpm_IP1($this->sessionStatus, $this->createContextFromModels());
