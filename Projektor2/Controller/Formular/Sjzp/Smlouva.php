 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjzp_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultFormular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Sjzp_Smlouva($this->sessionStatus, $this->createContextFromModels(TRUE));
    ...
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Sjzp_Smlouva($this->sessionStatus, $this->createContextFromModels());   
