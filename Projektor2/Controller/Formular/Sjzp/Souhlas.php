 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjzp_Souhlas extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultFormular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Sjzp_Souhlas($this->sessionStatus, $this->createContextFromModels(TRUE));    
