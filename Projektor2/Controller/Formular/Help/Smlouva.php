 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Help_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultFormular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Help_Smlouva($this->sessionStatus, $this->createContextFromModels(TRUE));
