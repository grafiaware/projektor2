 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Help_Dotaznik extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function formular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Help_Dotaznik($this->sessionStatus, $this->createContextFromModels(TRUE));
