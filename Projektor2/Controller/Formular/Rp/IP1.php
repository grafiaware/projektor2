 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Rp_IP1 extends Projektor2_Controller_Formular_IP {
    ...
    protected function getResultFormular() {
        ...
        $view->assign('nadpis', 'INDIVIDUÁLNÍ PLÁN účastníka projektu „Rodina i práce v Plzeňském kraji“ ')
            ->assign('formAction', 'rp_plan_uc')
     ...
     protected function getResultPdf() {
        if ($this->request->post('pdf') == "Tiskni IP 1.část") {
            ...
            $view = new Projektor2_View_PDF_Rp_IP1($this->sessionStatus, $this->createContextFromModels());
