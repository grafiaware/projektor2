 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Rp_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function getResultFormular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Rp_Smlouva($this->sessionStatus, $this->createContextFromModels(TRUE));
    ...
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Rp_Smlouva($this->sessionStatus, $this->createContextFromModels());   
