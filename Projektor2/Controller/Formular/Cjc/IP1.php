 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Cjc_IP1 extends Projektor2_Controller_Formular_IP {
    ...
    protected function getResultFormular() {
     ...
     protected function getResultPdf() {
        ...
        if (strpos($this->request->post('pdf'), 'Tiskni osvědčení Grafia') === 0 ) {
            ...
            $params = array('idSKurzFK'=>$aktivitaPlan->sKurz->id_s_kurz, 'datumCertif' => $aktivitaPlan->datumCertif, 'certifikatTyp'=>4);
