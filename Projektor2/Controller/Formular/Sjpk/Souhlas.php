 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjpk_Souhlas extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function formular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Sjpk_Souhlas($this->sessionStatus, $this->createContextFromModels(TRUE));    
        $htmlResult .= $view->render();
        return $htmlResult;
    }
    
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Sjpk_Souhlas($this->sessionStatus, $this->createContextFromModels());
