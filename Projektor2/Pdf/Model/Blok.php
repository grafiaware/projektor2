...
class Projektor2_PDF_Blok
{
    ...
    const FONT = 'Times';
    const STYLE= '';   // style může být '', 'I' pro nadpisy bloku a odstavce se automaticky před style přidává písmeno 'B' a vzniká 'B' nebo 'BI'
    const NADPIS = false;
    const TEXT = false;
    ...
    public function __construct($font=self::FONT, $style=self::STYLE, $nadpis=self::NADPIS, $text=self::TEXT, $barvaPisma=self::BARVA_PISMA,
    ...
    public function Style($styleString) {
    ...
    /**
     * Možnosti: C Centered, R Right, L Left
     * @param string $ZarovnaniNadpisu C, R, L
     */
    ...
    /**
     * Možnosti: C Centered, R Right, L Left
     * @param string $ZarovnaniTextu C, R, L
     */
