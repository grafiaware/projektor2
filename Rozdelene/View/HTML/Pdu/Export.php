 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Pdu_Export extends Framework_View_Abstract {
        ...
        $this->parts[] = '<div class="content">';
            $this->parts[] = '
                            <form method="POST" action="index.php?akce=vdtp_export" name="vyber_tabulky">
                                ...
                                <option >------------</option>
                                <option >v_pdu_zajemci</option>
                                <option >v_pdu_kurzy</option>
                                <option >v_pdu_plan_kurzu</option>
                                </select><br>
