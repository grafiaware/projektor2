 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Vdtp_Export extends Framework_View_Abstract {
    ...
    public function render() {
        ...
        $this->parts[] = '<div class="content">';
            $this->parts[] = '
                            <form method="POST" action="index.php?akce=vdtp_export" name="vyber_tabulky">
                                  Databázové tabulky: <br>
                                <select ID="dbtabulka" size="1" name="dbtabulka">
                                <option >------------</option>
                                <option >v_vdtp_zajemci</option>
                                <option >v_vdtp_kurzy</option>
                                <option >v_vdtp_plan_kurzu</option>
                                </select><br>
