 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Sjpk_Zamestnani extends Projektor2_View_HTML_FormularPHP4 {
    ...
    //form
    echo '<form method="POST" action="index.php?akce=osoby&osoby=form&form=sjpk_zamestnani_uc&save=1" name="zamestnani->form_zamestnani">';
