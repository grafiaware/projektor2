 ...
 * @author pes2704
 */
class Projektor2_View_PDF_Pdu_Ukonceni extends Projektor2_View_PDF_Common {
    const MODEL_UKONCENI = "ukonceni->";
    const MODEL_DOTAZNIK = "dotaznik->";

    public function createPDFObject() {
        $textPaticky = "Ukončení účasti účastníka v projektu ".$this->context["file"].$this->context["file"];
        $this->createHeaderFooter($this->sessionStatus->getUserStatus()->getProjekt(), $textPaticky);
        $this->initialize();
        //*****************************************************
        $textyNadpisu[] = "UKONČENÍ ÚČASTI V PROJEKTU";
        $textyNadpisu[] = '„Podpora zaměstnanosti dlouhodobě nezaměstnaných uchazečů o zaměstnání“';
        ...
        $blok = new Block;
            ...
            $blok->PridejOdstavec("Účastník ukončil účast v projektu „Podpora zaměstnanosti dlouhodobě nezaměstnaných uchazečů o zaměstnání“ z dále uvedeného důvodu. "
                    . "Ke dni ukončení účasti skončila účinnost Dohody o účasti v projektu „Vzdělávání a dovednosti pro trh práce II“.");
