 ...
 * @author pes2704
 */
class Projektor2_View_PDF_Sjpo_Smlouva extends Projektor2_View_PDF_Common {
...
// ??
            $blok->PridejOdstavec("1.2 Hlavním cílem projektu je zvýšit kvalifikaci nezaměstnaným osobám a pomoci jim získat adekvátní pracovní uplatnění. Realizován bude v Plzeňském kraji.");
...
// ??
            $blok->PridejOdstavec("4.5 Po ukončení rekvalifikačního kurzu (zahrnujícího rekvalifikační kurzy a kurzy obsluhy PC) Příjemce zajistí, že rekvalifikační zařízení zhotoví a předá účastníkovi, který kurz úspěšně absolvoval, Osvědčení o rekvalifikaci (případně jiné doklady, například průkazy atd.).");
            $blok->PridejOdstavec("4.6 Příjemce založí každému účastníkovi jeho Osobní složku, do které bude zakládat, počínaje touto Dohodou o účasti v projektu a Souhlasem s poskytnutím a zpracováním osobních údajů, všechny dokumenty vztahující se k jeho účasti v projektu. Osobní složky budou uloženy po dobu trvání plnění projektu v příslušném Konzultačním centru projektu. Osobní složka každého účastníka projektu bude pro konkrétního účastníka přístupná v době dohodnuté konzultační schůzky v Konzultačním centru.");
        $this->pdf->TiskniBlok($blok);
...
//        $this->pdf->TiskniBlok($blok);
        ...
        $blok = clone $defaultBlokCislovani2;
            ...
            $blok->Odstavec("7.1 Účastník souhlasil s poskytnutím a zpracováváním svých osobních údajů v rozsahu, pro úřel a na dobu uvedenou v písemném souhlasu, který je samostatným dokumentem. Účastník souhlasí s tím, že neposkytnutí nebo odvolání souhlasu ke zpracování osobních údajů pro účel zprostředkování zaměstnání způsobí omezení nebo vyloučení aktivit příjemce v aoblasti zprostředkování zaměstnání účastníka. Tuto skutečnost účastník potvrzuje podpisem této Dohody.");
        $this->pdf->TiskniBlok($blok);
