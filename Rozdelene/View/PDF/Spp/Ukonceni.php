 ...
 * @author pes2704
 */
class Projektor2_View_PDF_Spp_Ukonceni extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $blok = new Block;
            ...
            $blok->PridejOdstavec("Účastník ukončil účast v projektu „Šance pro padesátníky v Plzeňském kraji“ z dále uvedeného důvodu. "
                    . "Ke dni ukončení účasti skončila účinnost Dohody o účasti v projektu „Šance pro padesátníky v Plzeňském kraji“.");
