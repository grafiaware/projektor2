...
//        $this->tiskniTitul($textyNadpisu, TRUE);
        ...
        $blok = clone $defaultBlokCislovani2;
            ...
            $blok->Odstavec("1.1 Účelem dohody uzavírané dle občanského zákoníku a zákona č. 435/2004 Sb., o zaměstnanosti je úprava vzájemného vztahu mezi účastníkem a dodavatelem při provádění aktivit pro fyzické osoby účastnící se vzdělávacího programu: $nazevProjektu.");
// ??
            $blok->PridejOdstavec("1.2 Hlavním cílem programu je zvýšit kvalifikaci cizinců v České republice a pomoci jim získat adekvátní pracovní uplatnění.");
