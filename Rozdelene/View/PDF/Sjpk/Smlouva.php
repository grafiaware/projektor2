 ...
 * @author pes2704
 */
class Projektor2_View_PDF_Sjpk_Smlouva extends Projektor2_View_PDF_Common {
    const MODEL_SMLOUVA = "smlouva->";   //--vs
    
    public function createPDFObject() {
        $nazevProjektu = '„S jazyky za prací v Plzeňském a Karlovarském kraji“';
...
// ??
            $blok->PridejOdstavec("1.2 Projekt představuje soubor aktivit a nástrojů určených pro dosažení cílů projektu. Hlavním cílem $nazevProjektu je zvýšit kvalifikaci nezaměstnaným osobám z cílových skupin a pomoci jim získat adekvátní pracovní uplatnění v Plzeňském a Karlovarském kraji."
                    . " Projekt je zaměřen na aktivizaci a motivaci, posílení sebevědomí účastníků; sebepoznání a nalezení dovedností účastníků uplatnitelných na trhu práce, lepší porozumění trhu práce; posílení stávajících obecných dovedností pro trh práce a jejich rozvoj - komunikační a sociální dovednosti, PC dovednosti, podnikavost, schopnost týmové práce; získání nových profesních dovedností - rekvalifikace, popř. další odborné kurzy a intenzívní kurzy; nalezení vhodného zaměstnání; posílení uplatnitelnosti účastníků na trhu práce.");
