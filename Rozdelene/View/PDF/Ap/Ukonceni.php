 ...
 * @author pes2704
 */
class Projektor2_View_PDF_Ap_Ukonceni extends Projektor2_View_PDF_Common {
    ...
    public function createPDFObject() {
        ...
        $blok = new Block;
            ...
            $blok->PridejOdstavec("Účastník ukončil účast v projektu „Alternativní práce v Plzeňském kraji“ z dále uvedeného důvodu. "
                    . "Ke dni ukončení účasti skončila účinnost Dohody o účasti v projektu „Alternativní práce v Plzeňském kraji“.");
    ...
    //    	$ukonceniUcasti->PridejBunku("Datum zahájení účasti v projektu: ", $pdfpole["datum_reg"]);
        ...
        if (isset($ukonceniUcasti1)) $this->pdfRenderer->renderBlock($ukonceniUcasti1);
        $pozn = new Block;
