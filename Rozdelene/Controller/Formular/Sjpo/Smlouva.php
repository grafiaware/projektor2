 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Sjpo_Smlouva extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function formular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Sjpo_Smlouva($this->sessionStatus, $this->createContextFromModels(TRUE));
    ...
    protected function getResultPdf() {
        $view = new Projektor2_View_PDF_Sjpo_Smlouva($this->sessionStatus, $this->createContextFromModels()); 
