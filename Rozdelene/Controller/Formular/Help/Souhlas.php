 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Help_Souhlas extends Projektor2_Controller_Formular_FlatTable {
    ...
    protected function formular() {
        $htmlResult = "";
        $view = new Projektor2_View_HTML_Help_Souhlas($this->sessionStatus, $this->createContextFromModels(TRUE));
